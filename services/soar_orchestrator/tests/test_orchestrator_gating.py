...
from orchestrator import _parse_observables, should_create_thehive_case  # noqa: E402
...
def test_parse_observables_dedupes_and_skips_private_ips(monkeypatch):
    monkeypatch.delenv("SKIP_PRIVATE_IP_OBSERVABLES", raising=False)

    observables = _parse_observables([
        {"type": "ip", "value": "10.1.2.3", "role": "src"},
        {"type": "ip", "value": "8.8.8.8", "role": "dst"},
        {"type": "ip", "value": "8.8.8.8", "role": "dst"},
...
def test_parse_observables_can_keep_private_ips(monkeypatch):
    monkeypatch.setenv("SKIP_PRIVATE_IP_OBSERVABLES", "false")

    observables = _parse_observables([{"type": "ip", "value": "10.1.2.3"}])

    assert observables == [{"type": "ip", "value": "10.1.2.3"}]
